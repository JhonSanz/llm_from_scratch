...
> **DEFINICIÓN DE PUNTO INTERIOR.** *Sea $S$ un subconjunto de $\mathbf{R}^n$, y supongamos
> que $a \in S$. Se dice que $a$ es punto interior de $S$ si existe una $n$-bola abierta
> con centro en $a$, cuyos puntos pertenecen todos a $S$.*
