...
Ahora probemos con otro polinomio desconocido $q$, pero esta vez uno de segundo grado, pero ahora que coincida con $f$ hasta la segunda derivada en 0, es decir:
...
$$q(0) = 1 + 0 + \frac{1}{2}0^2 = 1$$
$$q'(x) = 1 + x \rightarrow q'(0) = 1$$
$$q''(x) = 1 \rightarrow q''(0) = 1$$
